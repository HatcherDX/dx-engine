...
describe('TerminalStrategies', () => {
  ...
  describe('task-detail strategy', () => {
    ...
    it('should handle character input with bridge', () => {
      ...
      expect(mockContext._state.cursorPosition).toBe(4)
    })
  ...
  describe('branch-creation strategy', () => {
    ...
    it('should get branches from window', () => {
      ...
      // eslint-disable-next-line @typescript-eslint/no-unused-vars, @typescript-eslint/no-unsafe-function-type -- Test validates side effects
