...
export interface OnboardingAPI {
  ...
  // eslint-disable-next-line @typescript-eslint/no-explicit-any -- Recent projects collection requires flexible typing for heterogeneous project metadata structures
  recentProjects: Ref<any[]>
  // eslint-disable-next-line @typescript-eslint/no-explicit-any -- Branch configuration requires flexible typing
  getSelectedBranch?: ComputedRef<any>
}
