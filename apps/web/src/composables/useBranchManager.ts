  ...
  async function selectBranch(
    ...
    try {
      ...
      if (hasUncommittedChanges) {
        ...
        // eslint-disable-next-line @typescript-eslint/no-explicit-any -- Git status file structure varies by implementation
        const changedFiles = statusResult.files.map((file: any) => file.path)
