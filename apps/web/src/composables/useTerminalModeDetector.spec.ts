...
describe('🚀 useTerminalModeDetector - Real API Coverage', () => {
  ...
  describe('🎯 Coverage: Electron API testing edge cases', () => {
    ...
    it('should handle Electron API test throwing exceptions', async () => {
      ...
      // eslint-disable-next-line @typescript-eslint/no-unused-vars -- Original function saved for test cleanup but not used
  ...
  describe('🎯 Coverage: sendMessage timeout and fallback scenarios', () => {
    ...
    it('should handle sendMessage error counter increment', async () => {
      ...
      try {
        ...
        // eslint-disable-next-line @typescript-eslint/no-unused-vars -- Error caught but not used in this test scenario
      } catch (_error) {
