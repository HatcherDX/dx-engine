...
describe('useBreadcrumbContext', () => {
  ...
  it('should initialize with default context', () => {
    ...
    // But projectDisplayName computed property returns 'Workspace' when no project is loaded
    expect(breadcrumb.projectDisplayName.value).toBe('Workspace')
  })
  ...
  it('should update code context', () => {
    ...
    expect(context.projectName).toBe('Workspace')
  ...
  it('should get context for code mode', () => {
    ...
    // When no project is loaded, projectDisplayName is 'Workspace'
    expect(context).toEqual({
