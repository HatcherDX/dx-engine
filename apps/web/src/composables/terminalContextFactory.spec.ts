  ...
  describe('BaseTerminalContext', () => {
    ...
    describe('executeCommand()', () => {
      ...
      it('should not show silent commands', () => {
        // eslint-disable-next-line @typescript-eslint/no-unused-vars -- Line count tracked for test validation
  ...
  describe('TerminalContextFactory', () => {
    ...
    describe('removeFromCache()', () => {
      ...
      it('should not affect other cached contexts', () => {
        // eslint-disable-next-line @typescript-eslint/no-unused-vars -- Context created for test validation
