...
vi.mock('@vueuse/core', () => ({
  useStorage: vi.fn(
    // eslint-disable-next-line @typescript-eslint/no-explicit-any -- Parameters required by function signature but not used in mock implementation; Test requires flexible typing for validation testing
