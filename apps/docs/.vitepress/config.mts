...
export default defineConfig({
  ...
  locales: {
    root: {
      label: 'English',
      lang: 'en',
      description: 'The IDE for builders who ship. Open-source development environment designed for controlled amplification with AI engines.',
    ...
    es: {
      label: 'Español',
      lang: 'es',
      description: 'El IDE para creadores que entregan. Entorno de desarrollo de código abierto diseñado para amplificación controlada con motores de IA.',
