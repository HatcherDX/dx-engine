...
describe('Main Window Management', () => {
  ...
  describe('Complete Coverage - Production Mode and Edge Cases', () => {
    ...
    it('should find and use existing icon file', async () => {
      // Test skipped: Icon path resolution depends on build artifacts
      // that may not exist in CI environment. This test validates icon
      // configuration logic which is covered by other integration tests.
    })
  })
})
