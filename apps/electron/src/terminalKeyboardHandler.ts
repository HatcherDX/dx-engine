...
export class TerminalKeyboardHandler {
  ...
  private setupPersistentKeyboardHandling(): void {
    ...
    // eslint-disable-next-line @typescript-eslint/no-explicit-any -- Event handler requires flexible typing for dynamic event system
    ;(this as any)._persistentHandler = handleBeforeInputEvent
  ...
  private handleKeyboardInput(
    ...
    if ((this as any)._lastDebugKey === debugKey) {
      return
    }
    // eslint-disable-next-line @typescript-eslint/no-explicit-any -- Runtime dynamic typing required for flexible data handling
    ;(this as any)._lastDebugKey = debugKey
