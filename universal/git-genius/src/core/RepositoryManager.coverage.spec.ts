...
describe('🎯 RepositoryManager Coverage Tests', () => {
  ...
  describe('🎯 Line 583: File watcher setup error handling', () => {
    it('should handle file watcher setup errors gracefully', async () => {
      ...
      // eslint-disable-next-line @typescript-eslint/no-explicit-any -- Test variable not used in this scenario
      ...
      ;(manager as any).setupFileWatcher = async function (
        ...
        // eslint-disable-next-line @typescript-eslint/no-explicit-any -- Mock function signature requires flexible typing
        _instance: any
      ) {
        try {
