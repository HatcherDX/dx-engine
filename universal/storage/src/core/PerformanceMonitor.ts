...
export class NullPerformanceMonitor implements PerformanceMonitor {
  // eslint-disable-next-line @typescript-eslint/no-unused-vars -- Required by PerformanceMonitor interface but intentionally unused in null implementation
  record(_metrics: PerformanceMetrics): void {
    // No-op
  }
  ...
  // eslint-disable-next-line @typescript-eslint/no-unused-vars -- Required by PerformanceMonitor interface but intentionally unused in null implementation
  getMetricsByOperation(_operation: string): PerformanceMetrics[] {
    return []
  }
