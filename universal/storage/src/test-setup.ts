...
// CRITICAL: Import test-mocks FIRST to ensure vi.mock() calls are hoisted
import './test-mocks'
...
// NOTE: Tests now use real native dependencies (better-sqlite3, argon2) instead of mocks
