...
describe('CompressionService', () => {
  ...
  describe('edge cases and error paths', () => {
    ...
    it('should handle brotli compression with fallback to gzip', async () => {
      ...
      // Use larger, repetitive data that actually benefits from compression
      // Brotli compression works best on larger data with patterns
      const data = 'Test data for brotli fallback testing. '.repeat(100)
